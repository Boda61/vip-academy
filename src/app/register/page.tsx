...
function RegisterContent() {
  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col items-center justify-between p-4 sm:p-8" dir="rtl">
      {/* Top Header */}
      <header className="w-full max-w-2xl flex items-center justify-between py-4 border-b border-slate-200">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-xl bg-blue-600 flex items-center justify-center font-bold text-white shadow-sm shadow-blue-500/20">
            VIP
          </div>
          <div>
            ...
            <p className="text-[11px] text-slate-500 font-medium">نظام تسجيل الطلاب</p>
          </div>
        </div>

        <div className="flex items-center gap-1.5 text-xs font-semibold px-3 py-1.5 rounded-full bg-blue-50 text-blue-700 border border-blue-100">
      ...
      <main className="flex-1 flex flex-col items-center justify-center w-full my-8">
        {claiming ? (
          <div className="text-center py-12">
            ...
            <p className="text-xs text-slate-500 mt-1">يرجى الانتظار لبضع ثوانٍ</p>
          </div>
          ...
          <div className="w-full max-w-md bg-white border border-slate-200 rounded-2xl p-8 text-center shadow-sm">
            ...
            <div className="p-4 bg-slate-50 border border-slate-200/80 rounded-xl text-xs text-slate-600 mb-2 flex items-center gap-2.5 text-right">
      ...
      {/* Footer */}
      <footer className="w-full max-w-2xl text-center border-t border-slate-200 pt-4 text-xs text-slate-500">
